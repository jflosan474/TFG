...
setcookie('id_categorya', 4, time() + (86400 * 30), "/"); // Valor 1 para la categoría de pierna
...
<head>
    ...
    <title>Entrenamientos de Piernas</title>
    <style>
        body {
...
<body>
    <h2>Entrenamientos de Piernas</h2>
    ...
    // Consulta SQL para obtener los entrenamientos de pierna
    $sql = "SELECT * FROM Entrenamiento WHERE ID_categorya = 4"; // Suponiendo que el ID de la categoría de pierna es 1
    ...
    if ($result->num_rows > 0) {
        ...
        echo "No se encontraron entrenamientos de pierna";
    }
