...
// Obtener el ID de usuario basado en el nombre de usuario logado
$sql_id_usuario = "SELECT ID_usuario FROM Usuario WHERE usuario='$usuario_logado'";
...
<body>
    <div class="panel-container">
        ...
        <div class="buttons-container">
            <a href="perfil_usuario.php?id_usuario=<?php echo $id_usuario; ?>">
                <button>
                    <img src="perfyl.png" alt="Perfil">
                    <span>Perfil</span>
                </button>
            </a>
            <a href="entrenamientos_usuario.php?id_usuario=<?php echo $id_usuario; ?>">
                <button>
