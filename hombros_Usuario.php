...
setcookie('id_categorya', 3, time() + (86400 * 30), "/"); // Valor 1 para la categoría de hombro
...
<head>
    ...
    <title>Entrenamientos de Hombros</title>
    <style>
        body {
...
<body>
    <h2>Entrenamientos de Hombros</h2>
    ...
    // Consulta SQL para obtener los entrenamientos de hombro
    $sql = "SELECT * FROM Entrenamiento WHERE ID_categorya = 3"; // Suponiendo que el ID de la categoría de hombro 1
    ...
    if ($result->num_rows > 0) {
        ...
        echo "No se encontraron entrenamientos de hombro";
    }
