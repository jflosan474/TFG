<?php
// Configurar la cookie de categoría con valor 2
setcookie('id_categorya', 2, time() + (86400 * 30), "/"); // Valor 2 para la categoría de abdominales
...
<head>
    ...
    <title>Entrenamientos de Abdominales</title>
    <style>
        body {
...
<body>
    ...
    // Consulta SQL para obtener los entrenamientos de abdominales
    $sql = "SELECT * FROM Entrenamiento WHERE ID_categorya = 2"; // Suponiendo que el ID de la categoría de abdominales es 2
