<?php
// Configurar la cookie de categoría con valor 5 para la categoría de pecho
setcookie('id_categorya', 5, time() + (86400 * 30), "/"); // Valor 5 para la categoría de pecho
...
<body>
    ...
    $sql = "SELECT * FROM Entrenamiento WHERE ID_categorya = 5"; // Suponiendo que el ID de la categoría de pecho es 5
