...
setcookie('id_categorya', 2, time() + (86400 * 30), "/"); // Valor 1 para la categoría de abdomynales
...
<head>
    ...
    <title>Entrenamientos de Abdomnales</title>
    <style>
        body {
...
<body>
    <h2>Entrenamientos de Abdominales</h2>
    <div class="button-container">
         <a href="entrenamientos_Usuario.php" class="btn-volver">Volver a la selección de categorías</a>
    </div>
    <?php
    // Datos de conexión a la base de datos
    $servername = "localhost";
    ...
    // Consulta SQL para obtener los entrenamientos de abdomynales
    $sql = "SELECT * FROM Entrenamiento WHERE ID_categorya = 2"; // Suponiendo que el ID de la categoría de abdomynales es 1
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<table>";
        echo "<tr><th>Nombre</th><th>Visualizar</th></tr>";
        while ($row = $result->fetch_assoc()) {
            echo "<tr>";
            echo "<td>".$row["nombre"]."</td>";
            echo "<td><a href='ejercicios_Usuario.php?id_entrenamiento=".$row["ID_entrenamiento"]."'><button class='btn-visualizar'>Visualizar</button></a></td>";
   
            echo "</tr>";
        }
        echo "</table>";
    } else {
        echo "No se encontraron entrenamientos de abdominales";
    }
