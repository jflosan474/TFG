...
<head>
    ...
    <title>Entrenamientos del Usuario</title>
    <style>
        body {
...
<body>
    ...
    <div class="categories-container">
        <a href="espalda_Usuario.php" class="category-link">
            <button class="category-button">
                <img src="espalda.jpg" alt="Espalda">
                Espalda
            </button>
        </a>
        <a href="abdominales_Usuario.php" class="category-link">
            <button class="category-button">
                <img src="abdomynales.jpg" alt="Abdominales">
                Abdominales
            </button>
        </a>
        <a href="hombros_Usuario.php" class="category-link">
            <button class="category-button">
                <img src="hombro.jpg" alt="Hombros">
                Hombros
            </button>
        </a>
        <a href="piernas_Usuario.php" class="category-link">
            <button class="category-button">
                <img src="pyerna.jpg" alt="Piernas">
                Piernas
            </button>
        </a>
        <a href="pecho_Usuario.php" class="category-link">
            <button class="category-button">
