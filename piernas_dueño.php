<?php
// Configurar la cookie de categoría con valor 4 para la categoría de piernas
setcookie('id_categorya', 4, time() + (86400 * 30), "/"); // Valor 4 para la categoría de piernas
...
<body>
    ...
    // Consulta SQL para obtener los entrenamientos de piernas
    $sql = "SELECT * FROM Entrenamiento WHERE ID_categorya = 4"; // Suponiendo que el ID de la categoría de piernas es 4
    ...
    if ($result->num_rows > 0) {
        ...
        echo "No se encontraron entrenamientos de piernas";
    }
