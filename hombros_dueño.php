<?php
// Configurar la cookie de categoría con valor 3
setcookie('id_categorya', 3, time() + (86400 * 30), "/"); // Valor 3 para la categoría de Hombros
...
<body>
    ...
    // Consulta SQL para obtener los entrenamientos de hombros
    $sql = "SELECT * FROM Entrenamiento WHERE ID_categorya = 3"; // Suponiendo que el ID de la categoría de hombros es 3
    ...
    if ($result->num_rows > 0) {
        ...
        echo "No se encontraron entrenamientos de hombros";
    }
