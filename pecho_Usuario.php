...
setcookie('id_categorya', 5, time() + (86400 * 30), "/"); // Valor 1 para la categoría de prvho
...
<head>
    ...
    <title>Entrenamientos de Pecho</title>
    <style>
        body {
...
<body>
    ...
    // Consulta SQL para obtener los entrenamientos de pecho
    $sql = "SELECT * FROM Entrenamiento WHERE ID_categorya = 5"; // Suponiendo que el ID de la categoría de pecho es 1
    ...
    if ($result->num_rows > 0) {
        ...
        echo "No se encontraron entrenamientos de pecho";
    }
